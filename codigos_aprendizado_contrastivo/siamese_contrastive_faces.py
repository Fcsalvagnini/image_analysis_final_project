...
save_figure(training_loss, validation_loss, "Training and Validation Loss", "Epochs", "Loss", "loss_contrastive_faces.pdf")

save_figure(training_acc, validation_acc, "Training and Validation Accuracy", "Epochs", "Accuracy", "accuracy_contrastive_faces.pdf")
...
save_tsne_projection(outputA, labels, 0, nclasses, "Projection of the input MLP layer", "tsne-1st-layer_contrastive_faces.pdf")

save_tsne_projection(outputA, labels, 1, nclasses, "Projection of the first hidden MLP layer", "tsne-2nd-layer_contrastive_faces.pdf")

save_tsne_projection(outputA, labels, 2, nclasses, "Projection of the second hidden MLP layer", "tsne-3rd-layer_contrastive_faces.pdf")

save_tsne_projection(outputA, labels, 3, nclasses, "Projection of the output MLP layer", "tsne-4th-layer_contrastive_faces.pdf")
